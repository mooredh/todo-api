...
describe('DELETE /todos/:id', () => {
    ...
    it("should return 404 if user tries to access someone elses todo", done => {
...
describe('PATCH /todos/:id', () => {
    ...
    it("should not update the todo when wrong unauthorized", done => {
        let id = todos[1]._id.toHexString();
        let text = "new test text";
    ...
    it('should clear completedAt when todo is not completed', (done) => {
        let id = todos[1]._id.toHexString();
        let text = "new test text for second";
